...
const TitleContent = () => {
  ...
  return (
    <>
      ...
      <div
        className="px-4 py-16 border rounded-md"
        style={{ backgroundColor: "#123d24" }}
      >
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="flex space-x-4">
          <div className="flex items-center space-x-2 border rounded-lg px-4 py-2">
            <img
              src="/img/Categories/Logo design_2x.png"
          ...
          <div className="flex items-center space-x-2 border rounded-lg px-4 py-2">
            <img
              src="/img/Categories/Architecture.png"
          ...
          <div className="flex items-center space-x-2 border rounded-lg px-4 py-2">
            <img
              src="/img/Categories/Photoshop.png"
              alt="Image Editing"
              width={40}
              height={40}
            />
          ...
          <div className="flex items-center space-x-2 border rounded-lg px-4 py-2">
            <img
              src="/img/Categories/T-Shirts.png"
              alt="T-Shirts & Merchandise"
              width={40}
              height={40}
            />
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <button className="bg-gray-100 text-gray-800 py-2 px-4 rounded-full">
