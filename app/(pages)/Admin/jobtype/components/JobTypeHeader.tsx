...
export default function JobTypeHeader() {
    ...
    return (
        <div className="flex flex-col gap-4 rounded-xl bg-white p-5 shadow sm:flex-row sm:items-center sm:justify-between mb-6">
            <div>
                <h2 className="text-lg font-semibold text-gray-800">Quản lý loại công việc</h2>
                <p className="text-sm text-gray-500">Danh sách và quản lý các loại công việc</p>
            </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                <div className="relative">
                    <input
                        ...
                        placeholder="Tìm tên loại công việc..."
            ...
            <JobTypeModal open={open} onClose={() => setOpen(false)} />
        </div>
    );
}
